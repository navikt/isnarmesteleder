...
import no.nav.syfo.narmestelederrelasjon.api.narmesteLederSelvbetjeningApiV1Path
...
class NarmestelederSelvbetjeningApiTest {
    ...
    private val url = narmesteLederSelvbetjeningApiV1Path
    private val validToken = generateJWTTokenx(
        ...
        fun `should return list of NarmestelederRelasjon for all historical PersonIdent both as innbygger and leder if request is successful`() =
            runTest {
                ...
                testApplication {
                    ...
                    assertEquals(
                        UserConstants.NARMESTELEDER_PERSONIDENTNUMBER.value,
                        lederRelasjon.narmesteLederPersonIdentNumber
                    )
                    ...
                    assertEquals(UserConstants.NARMESTELEDER_AKTIV_FOM, lederRelasjon.aktivFom)
